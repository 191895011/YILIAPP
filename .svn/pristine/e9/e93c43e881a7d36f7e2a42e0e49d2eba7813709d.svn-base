  ...
  <div class="hrss-menus">
    <mt-tabbar v-model="active">
      ...
      <mt-tab-item id="processconter" @click.native="handleMenusClick('myagency')">
        ...
        <mt-badge size="small" type="error" v-if="this.flowNums && this.flowNums > 0">{{this.flowNums}}</mt-badge>
      </mt-tab-item>
      <mt-tab-item id="question" @click.native="handleMenusClick('starNeworder')">
