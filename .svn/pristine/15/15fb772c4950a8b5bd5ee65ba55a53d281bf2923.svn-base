<template>
  <div class="resumewt hrss-per">
    <div class="hrss-search">
      <h2 style="margin-bottom:0">{{title.PersonTitle}}</h2>
    </div>
    <div class="hrss-per-main" style="height: calc(100vh - 1.88rem);">
      <el-collapse>
        <el-collapse-item>
          <template slot="title">
        ...
        <el-collapse-item>
          ...
          <div class="resume-jobadd">
            <mt-button type="primary" @click="ToUpload" size="large">新增</mt-button>
          </div>
        </el-collapse-item>
      </el-collapse>
